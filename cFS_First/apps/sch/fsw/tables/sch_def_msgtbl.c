...
/*{ { CFE_MAKE_BIG16(MD_WAKEUP_MID),            CFE_MAKE_BIG16(0xC000), CFE_MAKE_BIG16(0x0001), 0x0000 } }, */
  ...
  { { CFE_MAKE_BIG16(EPS_WAKE_UP_MID),CFE_MAKE_BIG16(0xC000), CFE_MAKE_BIG16(0x0001), 0x0000} },
    /* command ID #28 */
  { { CFE_MAKE_BIG16(COMS_WAKE_UP_MID),CFE_MAKE_BIG16(0xC000), CFE_MAKE_BIG16(0x0001), 0x0000} },
    /* command ID #29 */
  { { CFE_MAKE_BIG16(SCH_UNUSED_MID) } },
...
** Table file header
*/
CFE_TBL_FILEDEF(SCH_DefaultMessageTable, SCH_APP.MSG_DEFS, SCH message definitions table, sch_def_msgtbl.tbl)
