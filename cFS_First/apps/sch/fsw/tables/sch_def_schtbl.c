...
/*{  SCH_DISABLED, SCH_ACTIVITY_SEND_MSG,  1,  0, 24, SCH_GROUP_MD_WAKEUP }, */  /* MD Wakeup */
  {  SCH_ENABLED, SCH_ACTIVITY_SEND_MSG, 5,  0, 25,  SCH_GROUP_MD_WAKEUP},
  ...
  /* slot #1 */
  {  SCH_ENABLED, SCH_ACTIVITY_SEND_MSG,  10,  1, 26,  SCH_GROUP_MD_WAKEUP},
  {  SCH_UNUSED,   0,      0,  0, 0,  SCH_GROUP_NONE},                                        
  {  SCH_UNUSED,   0,      0,  0, 0,  SCH_GROUP_NONE},                                        
  {  SCH_UNUSED,   0,      0,  0, 0,  SCH_GROUP_NONE},                                        
  {  SCH_UNUSED,   0,      0,  0, 0,  SCH_GROUP_NONE},                                        
  ...
  /* slot #2 */
  {  SCH_ENABLED, SCH_ACTIVITY_SEND_MSG,  11,  3, 27,  SCH_GROUP_MD_WAKEUP},
  {  SCH_UNUSED,   0,      0,  0, 0,  SCH_GROUP_NONE},                                        
  {  SCH_UNUSED,   0,      0,  0, 0,  SCH_GROUP_NONE},                                        
  {  SCH_UNUSED,   0,      0,  0, 0,  SCH_GROUP_NONE},                                        
  {  SCH_UNUSED,   0,      0,  0, 0,  SCH_GROUP_NONE},                                        
  ...
  {  SCH_ENABLED, SCH_ACTIVITY_SEND_MSG,  12,  3, 28,  SCH_GROUP_MD_WAKEUP},
  {  SCH_UNUSED,   0,      0,  0, 0,  SCH_GROUP_NONE},                                        
  {  SCH_UNUSED,   0,      0,  0, 0,  SCH_GROUP_NONE},                                        
  {  SCH_UNUSED,   0,      0,  0, 0,  SCH_GROUP_NONE},                                        
  {  SCH_UNUSED,   0,      0,  0, 0,  SCH_GROUP_NONE},                                        
...
** Table file header
*/
CFE_TBL_FILEDEF(SCH_DefaultScheduleTable, SCH_APP.SCHED_DEF, SCH schedule table, sch_def_schtbl.tbl)
